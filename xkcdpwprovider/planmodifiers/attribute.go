...
// RequiresReplaceModifier See RequiresReplace
...
// NumberNumericAttributePlanModifier a Helper fpr getting numberNumericAttributePlanModifier
...
// RequiresReplaceIfValuesNotNull see RequiresReplace, this triggers only if value is null
